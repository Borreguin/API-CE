...
from flask_app.my_lib.utils import fill_information_usuario, fill_information_comite, get_files_for
...
class ConfirmacionMailAPI(Resource):
    ...
    def post(self, id_forma: str = "Id de la forma a buscar"):
        ...
        # filling information:
        html_str = fill_information_comite(html_str, formaFinalDB, get_files_for(id_forma))
        # mail configuration:
